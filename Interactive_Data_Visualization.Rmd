...
data1<-read.csv(file="~/Documents/GitHub/R-Club/data_files/data1.csv", header = TRUE)
...
# Bar grid plot
            ...
            rain<-read.csv(file="~/Documents/GitHub/R-Club/data_files/rainfall.csv", header = TRUE, stringsAsFactors = FALSE)
            str(rain)  
